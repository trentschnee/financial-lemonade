...
var eCache = {
    ...
    startGmBtn: document.querySelector(".start-game"),
...
var boardModule = function() {
     ...
     */
    var points = ['player', 'life'].reduce(function(a, p) {
        var myObject = {};
        myObject[p] = START_POINTS;
        return Object.assign({}, a, myObject);
    }, {});

    var gameBoard = eCache.board;
...
function player() {
    ...
    function playTurn(cardEl) {
        ...
        setTimeout(function() {
            ...
            // revealLemonPower();
            var lifeCard = document.querySelector(".life-card");
        ...
        // Wait 1250ms to compare the card scores
        setTimeout(function() {
            //reveal other power
...
var gamePlay = function() {
    /* event listeners */
    eCache.nextTurnBtn.addEventListener("click", function() {
        gameRound();
    });
...
eCache.startGmBtn.addEventListener("click", function() {
    gamePlay();
});